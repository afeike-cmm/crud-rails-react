...
class Beers extends React.Component {
    columns = [
        ...
        },
        {
            ...
            key: "action",
            render: (_text, record) => (
                <Popconfirm title="Are you sure you want to delete this record?" onConfirm={() => this.deleteBeer(record.id)} okText="Yes" cancelText="No">
                    <a href="#" type="danger">
                        Delete{" "}
                    </a>
                </Popconfirm>
    ...
    reloadBeers = () => {
        // WHY??? rerendering anytime state is set
        this.setState({ beers: [] });
        this.loadBeers();
    }
